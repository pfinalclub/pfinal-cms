        ...
        <div class="inner_wrapper aboutUs-container fadeInLeft animated wow">
            <div class="container">
                ...
                <div class="inner_section">
                    <div class="row">
                        <div class="col-md-6"><img class="img-responsive lazy"
                                                   data-original="{{asset('pc-static/img/about1.jpg')}}" align=""></div>
                        <div class="col-md-6">
                            <h3>定制软件</h3>
                            <p>我们的主要领域互联网产品！专门定制企业网站，微信开发，APP开发，小程序开发，各平台活动开发等。</p><br/>
                            <h3>关于我们?</h3>
                            <p>
                                庄浪衿若网络科技工作室位于庄浪县卧龙镇，我们技术应用领域是专研应用开发。衿若长期专注于软件研发、软件设计、定制软件服务等开发领域，凭借多年在应用软件开发积累的经验，衿若科技为你提供一站式建站定制解决方案。
                                　　衿若科技倡导“专业、务实、高效、创新”的企业精神。</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 about-us">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>业务介绍</h3>
                                    <p>
                                        衿若网络科技工作室成立于2019年6月4日，本工作室是对客户的业务应用需求而提供的软件产品及应用软件定制开发服务。<br/> <br/>
                                        衿若在精准把握业务需求的基础上，在已有软件及解决方案的基础上，选择合适的技术框架为客户量身定制，构建特定业务应用软件，实现业务应用整合和数据整合，满足客户的特殊需要，推动业务的创新发展。
                                ...
                                <div class="col-md-6">
                                    <h3>快速定制解决方案</h3>
                                    <p>
                                        快速开发选型：后台语言PHP 框架laravel APP客户端 apicloud android+ios h5开发 前端sass css3+html5
                                        vue交互可快速定制开发，重心都在业务，框架成熟、稳定、可靠、快速！
                                    </p>
        ...
        <div class="portfolio">
            ...
            <div class="isotope fadeInLeft animated wow grid"
                ...
                <figure style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;"
                        class="portfolio-item one-four   prototype isotope-item effect-oscar">

                    <div class="portfolio_img">
                        <img class="lazy" data-original="{{asset('pc-static/img/zz_yh.png')}}" style="height: 317px;" alt="http://zz-yh.com">
                    </div>
                    <figcaption>
                        <div>
                            <a href="{{asset('pc-static/img/zz_yh.png')}}" class="fancybox">
                                <h2>PFinal <span>社区</span></h2>
                                <p>PFinal社区</p>
                            </a>
                        </div>
                    </figcaption>
                ...
                <figure style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;"
                        class="portfolio-item one-four  prototype isotope-item effect-oscar">
                    <div class="portfolio_img"><img class="lazy" data-original="{{asset('pc-static/img/yuheng.png')}}"
                                                    alt="Portfolio 1" style="height: 317px;"></div>
                    <figcaption>
                        <div>
                            <a href="{{asset('pc-static/img/yuheng.png')}}" class="fancybox">
                                <h2>淘券鼠 <span>商务</span></h2>
                                <p>淘券鼠</p>
                            </a>
                        </div>
                    </figcaption>
                ...
                <figure style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;"
                        class="portfolio-item one-four  prototype design isotope-item effect-oscar">
                    <div class="portfolio_img"><img class="lazy" data-original="{{asset('pc-static/img/gat.png')}}"
                                                    alt="Portfolio 1"></div>
                    <figcaption>
                        <div>
                            <a href="{{asset('pc-static/img/gat.png')}}" class="fancybox">
                                <h2>PFinal海报生成 <span>工具</span></h2>
                                <p>PFinal海报生成 </p>
                            </a>
                        </div>
                    </figcaption>
